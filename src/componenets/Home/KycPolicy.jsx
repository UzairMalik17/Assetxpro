...
function KycPolicy() {
  return (
    <div className="w-full flex flex-col gap-8 justify-start item-center md:items-star">
      ...
      <p>
        Know your customer policies have become increasingly important worldwide
        lately, especially among banks and other financial institutions, in
        order to prevent identity theft, money laundering, financial fraud and
        terrorist activity. AssetXPro ™ holds a zero tolerance fraud policy, and
        is taking all measures possible to prevent it. Any fraudulent activity
        will be documented and all related accounts to it will be immediately
      ...
      <div>
        ...
        <p>
          ...
          last digits visible, back side with the CVV covered)A copy of a recent
          utility bill in your name and addressA signed purchase history of your
          online transactionsIf you have any questions please don’t hesitate to
          contact our customer support
        </p>
      </div>
      <div>
        <p className="font-bold">When do I need to provide these documents?</p>
        ...
        <p>
          ...
          before allowing any other activities in your account, such as deposits
          or trades.Please note that if we will not receive the required
          documents on file, your pending withdrawals will be cancelled and
          credited back to your trading account. We will notify you on such
          event via our system.
        </p>
      </div>
      <div>
        <p className="font-bold">
