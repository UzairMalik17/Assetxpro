  ...
  return (
    <div className="w-full flex flex-col gap-8 justify-start item-center md:items-star">
      ...
      <ul className="list-disc pl-8 gap-2">
        <li>
          I have read the following Terms and Conditions, including ASSETXPRO’s
          Policies (including, without limitation, Deposit and Withdrawal
          Policy, Risk Disclaimer and Risk Disclosure Policy, Acceptable Use
          Policy, Privacy and Underage Policy).
        </li>
        <li>
        ...
        <li>
          I am over 18 and the information provided in this application is true
          and correct and that I will notify ASSETXPRO of any material changes.
        </li>
        <li>
        ...
        <li>
          ...
          set out in this agreement by posting such information on our website.
        </li>
      </ul>
      <p>
      ...
      <p>
        By filling the Subscription Form I request and agree to open an account
        for myself and confirm that I have read and understood all policies and
        terms including the Risk Disclosure and Terms and Conditions.
      </p>
      <div>
        ...
        <p>
          Our obligations are subject to any limits or restrictions which we may
          agree in writing, and any statutory, or market requirements.
        </p>
      </div>
      <div>
      ...
      <p>
        In order to be eligible to operate your trading with ASSETXPRO you must
        be over the age of 18 and to fully understand the risks involved. You
        hereby acknowledge that you have the knowledge and experience to trade
        and understand the risks involved. We can’t be held responsible for any
        damage or loss and we are not responsible for verifying whether you
        possess sufficient knowledge or whether your trading choices are wise.
      </p>
    </div>
  );
}
